...
function WinInternal(props: WinProps) {
  ...
  return (
    <div>
      ...
      <p>Come by the Honeycomb booth at {props.eventName} to see how this compares with other scores, and to collect your prize!</p>
      <hr />
      <p>If you'd like to talk more about this quiz, or observability, or OpenTelemetry: chat with Jessitron in 
